...
class ItemRequestServiceImplIntTest {
    ...
    @Test
    void getItemRequest() {
        ItemReqResponseDto itemReqResponseDto = itemRequestService.getItemRequest(1L, 1L);
    ...
    void getOtherUsersItemRequests() {
        List<ItemReqResponseDto> itemRequests = itemRequestService.getOtherUsersItemRequests(2L, 1, 10);
    ...
    void createItemRequest() {
        ...
        ItemReqResponseDto itemReqResponseDto = itemRequestService.createItemRequest(itemReqRequestDto);
