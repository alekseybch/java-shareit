...
public class ItemRequestServiceImpl implements ItemRequestService {
    ...
    @Override
    public ItemReqResponseDto getItemRequest(Long requestId, Long userId) {
    ...
    @Override
    public List<ItemReqResponseDto> getOtherUsersItemRequests(Long userId, Integer from, Integer size) {
    ...
    public ItemReqResponseDto createItemRequest(ItemReqRequestDto itemReqDto) {
