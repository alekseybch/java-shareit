...
public class ItemServiceImpl implements ItemService {
    ...
    @Override
    public List<ItemResponseDto> findItem(String text, Integer from, Integer size) {
    ...
    @Override
    @Transactional(isolation = Isolation.SERIALIZABLE)
    public ItemResponseDto updateItem(Long userId, Long itemId, ItemPatchDto itemDto) {
