...
class UserServiceImplTest {
    ...
    void change_whenUserFound_thenChangedUser() {
        ...
        UserResponseDto actualUser = userService.change(userId, userPatchDto);
    ...
    void change_whenUserNotFound_thenNotFoundException() {
        ...
        assertThrows(EntityNotFoundException.class, () -> userService.change(userNotFound, userPatchDto));
    }
